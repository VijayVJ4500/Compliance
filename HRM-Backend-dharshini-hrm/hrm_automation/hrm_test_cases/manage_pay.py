...
class manage_pay_page(BasePage, unittest.TestCase):
    """
    ...
    def __init__(self, driver):
        ...
        self.logger = get_logger("Manage Pay")
    def manage_pay(self):
        self.click(Locators.HOME_SIDEBAR)
        time.sleep(1)
        self.driver.execute_script("window.scrollBy(0,400)")
        time.sleep(1)
        self.click(Locators.MANAGE_PAY_CARD)
        time.sleep(1)
        self.enter_text(Locators.MANAGE_SEARCH_FIL,"JAYA")
        time.sleep(1)
        self.click(Locators.MANAGE_RESET)
        time.sleep(2)
        self.click(Locators.MANAGE_DEFINE_BT)
        time.sleep(1)
        ...
        time.sleep(2)
        EARNING_1 = driver.find_element(By.XPATH,
