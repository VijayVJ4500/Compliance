...
class attritionget(IpssTestCases):
    ...
    def load_test_concurrent_get_requests(self, num_requests=100, num_threads=10):
        ...
        """
        url = "https://ipssapi.techgenzi.com/resign/attri_config_hrm/?results_per_page=10000"  # Endpoint for getting sequence configurations
