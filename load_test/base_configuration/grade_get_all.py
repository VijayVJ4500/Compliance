...
class gradeget(IpssTestCases):
    ...
    def load_test_concurrent_get_requests(self, num_requests=100, num_threads=10):
        ...
        """
        url = "https://ipssapi.techgenzi.com/employee_group_hrm/?results_per_page=10000&types=Grade"  # Endpoint for getting sequence configurations
