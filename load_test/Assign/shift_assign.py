...
class shiftassign(IpssTestCases):
    ...
    def load_test_concurrent_patch_requests(self, num_requests=100, num_threads=10):
        ...
        """
        url = "https://ipssapi.techgenzi.com/shift_mast_hrm/shift_assign/"

        payload = {"emp_ids":[29964,29963],"shift_id":142,"start_date":None,"end_date":None}
