...
class leaveassign(IpssTestCases):
    ...
    def load_test_concurrent_patch_requests(self, num_requests=100, num_threads=10):
        ...
        """
        url = "https://ipssapi.techgenzi.com/leave_assign_hrm/"

        payload = {"overall_employees":[29711,29714],"leave_type":834,"allocate_days":"5","default":False}
